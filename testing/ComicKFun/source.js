...
Object.defineProperty(exports, "__esModule", { value: true });
exports.ComicK = exports.ComicKFunInfo = void 0;
...
class ComicK extends paperback_extensions_common_1.Source {
    ...
    getSearchResults(query, metadata) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            const req = createRequestObject({
                url: `${API_BASE_URL}/search?tachiyomi=true&q=${q}&page=${page}`,
                method: "GET",
            });
            const data = yield this.requestManager.schedule(req, 2);
            const results = (0, ComicKFunParser_1.parseSearchItems)(data.data);
    ...
    getChapters(mangaId) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            const data = yield this.requestManager.schedule(req, 2);
            return (0, ComicKFunParser_1.parseChapters)(mangaId, data.data);
        });
    }
    ...
    getMangaDetails(mangaId) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            const data = yield this.requestManager.schedule(req, 2);
            return (0, ComicKFunParser_1.parseMangaDetails)(mangaId, data.data);
        });
    }
    getSearchTags() {
        return __awaiter(this, void 0, void 0, function* () {
            let req = createRequestObject({
                url: `${API_BASE_URL}/category?tachiyomi=true`,
                method: "GET",
            });
            const categoryData = yield this.requestManager.schedule(req, 2);
            req = createRequestObject({
                url: `${API_BASE_URL}/genre?tachiyomi=true`,
                method: "GET",
            });
            const genreData = yield this.requestManager.schedule(req, 2);
            return (0, ComicKFunParser_1.parseSearchTags)(categoryData.data, genreData.data);
        });
    }
    getHomePageSections(cb) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            for (const section of sections) {
                cb(section);
                const req = createRequestObject({
                    url: `${API_BASE_URL}/search?tachiyomi=true&sort=${section.id}&limit=10`,
                    method: "GET",
                });
    ...
    getViewMoreItems(id, metadata) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            const req = createRequestObject({
                url: `${API_BASE_URL}/search?tachiyomi=true&sort=${id}&limit=50`,
                method: "GET",
            });
...
const paperback_extensions_common_1 = require("paperback-extensions-common");
const parseTags = (data) => JSON.parse(data).map((item) => createTag({
    id: item.slug,
    label: item.name,
}));
const parseSearchTags = (categoryData, genreData) => {
    return [
        createTagSection({
            id: "genre",
            label: "Genre",
            tags: parseTags(genreData),
        }),
        createTagSection({
            id: "category",
            label: "Category",
            tags: parseTags(categoryData),
        }),
    ];
};
...
const parseMangaDetails = (mangaId, data) => {
    ...
    const titles = c.md_titles.map((item) => item.title);
    const relatedIds = c.relate_from
        .map((item) => item.relate_to.slug);
    const cats = c.mu_comics
        .mu_comic_categories
        .map((item) => {
        return createTag({
            label: item.mu_categories.title,
            id: item.mu_categories.slug,
        });
    });
...
const parseChapters = (mangaId, data) => JSON.parse(data)
    .chapters
    .map((c) => {
