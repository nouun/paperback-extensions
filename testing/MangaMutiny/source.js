...
Object.defineProperty(exports, "__esModule", { value: true });
exports.MangaMutiny = exports.MangaMutinyInfo = void 0;
...
class MangaMutiny extends paperback_extensions_common_1.Source {
    constructor() {
        super(...arguments);
    ...
    getSearchResults(query, metadata) {
        var _a;
        return __awaiter(this, void 0, void 0, function* () {
            const title = (_a = query.title) !== null && _a !== void 0 ? _a : "";
            //const page = metadata?.page ?? 1;
            const q = encodeURIComponent(title);
            const req = createRequestObject({
                url: `${API_BASE_URL}/manga?text=${q}&sort=title&limit=12`,
                method: "GET",
                headers: API_HEADERS,
            });
    ...
    getMangaDetails(mangaId) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            const tags = res.tags.map((item) => createTag({
                id: item,
                label: item,
            }));
            return createManga({
    ...
    getHomePageSections(cb) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            for (const section of sections) {
                ...
                switch (section.id) {
                    case "1":
                        sorting = "-lastReleasedAt";
                        break;
                    case "2":
                        sorting = "-createdAt";
                        break;
                    case "3":
                        sorting = "-rating+-ratingCount";
                        break;
                    default: return;
                }
                const req = createRequestObject({
                ...
                promises.push(this.requestManager.schedule(req, 2).then((res) => {
...
exports.MangaMutiny = MangaMutiny;
